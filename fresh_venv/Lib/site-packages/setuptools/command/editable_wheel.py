...
class editable_wheel(Command):
    ...
    def _install_namespaces(self, installation_dir, pth_prefix):
        ...
        if not dist.namespace_packages:
            return src_root = Path(self.project_dir, self.package_dir.get("", ".")).resolve()
...
def install():
    ...
    if not NAMESPACES:
        ...
        return if not any(hook == _EditableNamespaceFinder._path_hook for hook in sys.path_hooks):
