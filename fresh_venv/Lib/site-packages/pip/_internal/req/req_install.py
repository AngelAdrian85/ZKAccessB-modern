...
class InstallRequirement:
    ...
    def check_if_exists(self, use_user_site: bool) -> None:
        ...
        """
        if self.req is None:
            return existing_dist = get_default_environment().get_distribution(self.req.name)
        if not existing_dist:
            return version_compatible = self.req.specifier.contains(
    ...
    def archive(self, build_dir: Optional[str]) -> None:
        ...
        if not create_archive:
            ...
            return zip_output = zipfile.ZipFile(
            archive_path,
            "w",
