...
is not allowed.
        ...
        if not invalid:
            return msg = "Use of .. or absolute path in a resource path is not allowed."
...
class Distribution:
    ...
    def _warn_legacy_version(self):
        ...
        if not is_legacy:
            return # While an empty version is technically a legacy version and
    ...
    def insert_on(self, path, loc=None, replace=False):  # noqa: C901
        ...
        if not loc:
            return nloc = _normalize_cached(loc)
