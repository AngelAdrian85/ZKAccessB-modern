...
if hasattr(typing, "ReadOnly"):  # 3.13+
    ...
    def _clean_optional(obj, hints, globalns=None, localns=None):
        ...
        if not hints or isinstance(obj, type):
            return defaults = typing._get_defaults(obj)  # avoid accessing __annotations___
        if not defaults:
            return original_hints = obj.__annotations__
        ...
        if alen != elen:
            ...
            if hasattr(cls, "__parameters__"):
                ...
                if (num_tv_tuples > 0) and (alen >= elen - num_tv_tuples):
                    return # deal with TypeVarLike defaults
                ...
                if alen < elen:
                    ...
                    if (
                        ...
                        return num_default_tv = sum(getattr(p, '__default__', NoDefault)
