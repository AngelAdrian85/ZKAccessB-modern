...
class ImportTracker:
    ...
    def __init__(self) -> None:
        ...
        #                                ==> reverse_alias['m'] == 'mod'
        #     'import pkg.mod as m'      ==> module_for['m']  is None
        #                                ==> reverse_alias['m'] == 'pkg.mod'
        #     'import pkg.mod'           ==> module_for['pkg']  is None
        #                                ==> module_for['pkg.mod']  is None
    ...
    def import_lines(self) -> list[str]:
        ...
        for name in sorted(
            self.required_names,
            def key(n):
                return (self.reverse_alias[n], n) if n in self.reverse_alias else (n, ""),
        ):
