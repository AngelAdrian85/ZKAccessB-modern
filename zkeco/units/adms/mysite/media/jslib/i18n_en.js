...
catalog["提示：设备连接成功，但获取设备扩展参数失败"] = "Tip: The device is connected successfully, but failed to get the extended parameters for device";
catalog["，继续添加？"] = ",Continue to add?";
...
catalog["添加辅助点到当前地图"] = "Add auxiliary onto the current map";
catalog["请选择要添加的辅助点！"] = "Please choose the auxiliary you want to add!";
...
catalog["当前门处于常开状态，是否禁用当天常开时间段后关门？"] = "The current door is normal open now, whether to disable Intraday Passage Mode Time Zone and close the door?";
catalog["当前已常开"] = "Currently normal open";
...
catalog["请选择辅助输出点！"] = "Please select the auxiliary output point.";
catalog["请输入正确的时间！"] = "Please enter the correct time.";
...
catalog[" 的设备添加异常！原因："] = " device is added exceptionally, reason: ";
catalog["的设备添加成功，但设备扩展参数获取失败！原因："] = " device is added successfully, but its extension parameter fails to be obtained. Reason:";
...
catalog["设备连接失败(原因："] = "The device fails to be connected (Reason:";
...
catalog["请输入正确的电话号码"] = "Please enter a valid phone number!";
...
catalog["原 密 码:"] ="old password:";
catalog["新 密 码:"] ="New Password:";
catalog["密码修改"] = "Password Modify";
catalog["再次输入:"] = "re-enter:";
catalog["新密码，两次输入不一致"] = "Enter the new password twice inconsistent";
...
catalog["请选择门禁设备，该功能仅针对门禁设备"] = "Please choose access control equipment, this function only for access control equipment";
...
catalog["目前该功能仅支持IE系列及IE内核的浏览器，请更换！"] = "This function can only support IE seris browsers.Please change it!";
...
catalog["邮箱地址格式不正确"] = "Invalid Mailbox Address";
catalog["请输入邮箱地址"] = "Please enter the E-mail address";
catalog["邮件通知"] = "Email notification";
catalog["报警监控"] = "Alarm monitoring";
catalog["辅助输入"] = "Auxiliary Input";
catalog["辅助输出"] = "Auxiliary Output";
catalog["邮件通知"] = "Email notification";
catalog["请输入邮箱地址"] = "Please enter the E-mail address";
catalog["请输入邮箱地址，多个地址用 ';' 隔开"] = "Please enter the E-mail address, more address with ';'";
catalog["邮件发送成功!"] = "Mail sent successfully!";
catalog["邮件发送失败!"] = "Send mail failed!";
catalog["邮件发送失败,门禁参数配置中邮箱配置错误!"] = "Send mail failed, access control parameters in the configuration of mailbox configuration fault!";
catalog["请选择报警设备!"] = "Please choose the alarm device!";

catalog["门状态"] = "Door Status";
catalog["门锁状态"] = "Door State";
catalog["报警类型"] = "Alarm Type";
catalog["门关报警"] = "Door Closed And Alarm";
catalog["门开报警"] = "Door Open And Alarm";
catalog["门开超时"] = "Opening Timeout";
catalog["解锁"] = "Unlocked";
catalog["锁定"] = "Locked";
catalog["没有报警"] = "None";
catalog["防拆"] = "Tamper";
catalog["胁迫密码开门"] = "Duress Password Open";
catalog["门被意外打开"] = "Opened Forcefully";
catalog["请先关闭门！"] = "Please close the door first!";
catalog["胁迫开门"] = "Duress Open";
catalog["胁迫指纹开门"] = "Duress Fingerprint Open";

//in file--D:\trunk\units\adms\mysite\ Acc_Reportform.html
catalog["视频服务器登录失败，请确认后重试！原因："] = "Failed to login the video server, please check and try again! Reason: ";
catalog["视频服务器登录失败，请确认后重试！错误码："] = "Failed to login the video server, please check and try again! Error code: ";
catalog["视频回放失败，请确认后重试！原因："] = "Failed to play back the video, please check and try again! Reason: ";
catalog["视频回放失败，请确认后重试！错误码："] = "Failed to play back the video, please check and try again! Error code: ";
catalog["视频服务器登录失败，请确认后重试！"] = "Failed to login the video server, please check and try again!"
//视频模块国际化-start
catalog["当前系统中没有添加视频服务器，请添加！"] = "The system has no video server.Please add one first!";
catalog["视频通道不能重复选择，请重新选择！"] = "The video channel cannot be repeated selection, please select again!";
catalog["读头"] = "Reader";
catalog["名称"] = "Name";
catalog["开门延时不能小于0，请输入正确的延时时长!"] = "The interval of delay time cannot be less than 0s, please enter the correct one!";
catalog["视频时长不能小于0，请输入正确的视频时长!"] = "The interval of displaying video cannot be less than 0s, please enter the correct one!";
catalog["录像时长不能小于0，请输入正确的录像时长!"] = "The interval of recording video cannot be less than 0s, please enter the correct one!";
catalog["添加摄像机到当前地图"] = "Add cameras onto the current map";
catalog["请选择要添加的摄像头！"] = "Please choose the cameras you want to add!";
catalog["视频查询"] = "Video Search";
catalog["视频联动"] = "Video Linkage";
catalog["视频加载中，请稍侯......"] = "Video loading,please wait...";
catalog["该通道已达最大访问量或视频服务器未连接!"] = "The channel has reached its maximum traffic or video server is not connected!";
catalog["预览失败，请确认后重试！原因："] = "Preview fails, make sure and try again! Reasons:";
catalog["预览失败，请确认后重试！错误码："] = "Preview fails, make sure and try again!Error code:";
catalog["无此权限！"] = "No such permission!";
catalog["没有录像文件！"] = "No video files!";
catalog["该通道已达最大访问量或视频服务器未连接！"] = "The channel has reached its maximum traffic or video server is not connected!";
catalog["从视频服务器导出失败！"] = "Export fails from the Video Server!";
catalog["从视频服务器导出成功！"] = "Export success from the Video Server!";
catalog["视频弹出窗口高度必须为整数！"] = "Video pop-up window height must be an integer!";
catalog["请选择需要设置的对象!"] = "Please select the object you need to set up!";
catalog["请启用当前视频设备下被禁用的视频通道！"] = "Please enable video channel of current video equipment!";
//海康dvr last_error
catalog["HIKVISION_ERROR_1"] = "Wrong user or password.";
catalog["HIKVISION_ERROR_4"] = "Wrong channel No.";
catalog["HIKVISION_ERROR_5"] = "Exceed the maximum number of client to connect to the DVR.";
catalog["HIKVISION_ERROR_7"] = "Failed to connect the DVR.";
catalog["HIKVISION_ERROR_8"] = "Failed to send data to DVR.";
catalog["HIKVISION_ERROR_10"] = "Timeout while getting data from DVR.";
catalog["HIKVISION_ERROR_17"] = "Wrong parameter.";
catalog["HIKVISION_ERROR_19"] = "No hard disk.";
catalog["HIKVISION_ERROR_20"] = "Hard disk error.";
catalog["HIKVISION_ERROR_21"] = "Server hard disk is full.";
catalog["HIKVISION_ERROR_22"] = "Server hard disk error.";
catalog["HIKVISION_ERROR_24"] = "Server busy.";
catalog["HIKVISION_ERROR_28"] = "Lack of DVR resources.";
catalog["HIKVISION_ERROR_29"] = "DVR operation failed.";
catalog["HIKVISION_ERROR_33"] = "Server does not have the specified file while playback.";
catalog["HIKVISION_ERROR_36"] = "The last operation is not yet complete.";
catalog["HIKVISION_ERROR_38"] = "Playback error.";
catalog["HIKVISION_ERROR_46"] = "The number of maximum.";
catalog["HIKVISION_ERROR_47"] = "User not exist.";
catalog["HIKVISION_ERROR_52"] = "The largest number of users.";
catalog["HIKVISION_ERROR_74"] = "User ID in the cancellation of undergoing an operation.";
catalog["HIKVISION_ERROR_90"] = "Device being backed up.";

catalog["许可信息"] = "License Information";

catalog["请切换为英文输入法状态！"] = "Please switch to English input method state!";

catalog["许可信息"] = "License Information";
catalog["请选择每个扩展板的继电器数量！"] = "Please select the count of relays for each extended board!";
...
//访客
catalog["进入地点"] = "Place of entry";
catalog["离开地点"] = "Place of exit";
catalog["被访人姓名"] = "Personnel Firstname";
catalog["被访人姓氏"] = "Personnel Lastname";
catalog["是否重新打印访客单？"] = "Whether reprint Visitors single?";
catalog["没有注册读写器控件，是否下载控件？"] = "Not registered reader control whether to download controls?";
catalog["没有注册扫描仪控件，是否下载控件？"] = "Do not have a the registered scanner control, whether to download controls?";
catalog["暂时不支持该证件类型！"] = "Temporarily does not support the document type!";
catalog["请选择正确的证件类型或调整证件的位置！"] = "Please select the correct document type or location adjustment documents!";
catalog["加载核心失败！"] = "Loaded core failure!";
catalog["初始化失败！"] = "Initialization failed!";
catalog["请放好身份证！"] = "Please put away your ID!";
catalog["没有检测到身份证阅读器！"] = "ID card reader is not detected!";
catalog["目前该功能仅支持二代身份证！"] = "This feature is only support for the second generation ID card!";
catalog["没有可选的权限组！"] = "No available level .";
...
catalog["临时"] = "Temporarily";
catalog["get_visit_state"] = "Visitor State";

//init_base_frame.js
catalog["正式版许可"] = "The official version of license";
catalog["试用版许可"] = "Trial license";

catalog["断开"] = "Disconnected";
catalog["短路"] = "Shorted";
...
//Dev_RTMonitor.html
catalog["请先停止监控再导出！"] = "Please stop monitoring before export!";
catalog["服务未启动"] = "Service not Running";
catalog["门禁服务未启动，请先点击左方启动服务按钮"]= "Access service is not started, please click on the left 'Start Service' button";
catalog["门禁服务开启成功！"] = "Start access service successfully!";
catalog["邮箱测试发送成功！"] = "Test sent email successfully!";
catalog["接收者邮箱地址格式不正确！"] = "Invalid mailbox address for receive!";
catalog["请选择开始时间"] = "Please select the start time";
catalog["请选择结束时间"] = "Please select the end time";
catalog["只能查询3个月内的数据"] = "Only query data within three months";
catalog["只能查询2个月内的数据"] = "Only query data within two months";
catalog["只能查询1个月内的数据"] = "Only query data within one months";

//in file--D:\trunk\units\adms\mysite\ Acc_Option.html
catalog["发件人邮箱地址格式不正确"] = "Mailbox address is incorrectly formatted";
catalog["收件人邮箱地址格式不正确"] = "Recipient address is incorrectly formatted";
catalog["请输入邮件服务器(SMTP)地址"] = "Please enter mailbox server(SMTP) address";
catalog["服务器端口只能为数字"] = "Server port can only be a numeric";
catalog["服务器端口不能为0"] = "Server port can not be 0";
catalog["夏令时时间只能为数字！"] = "The DST time can only be a numeric!";
catalog["只支持导入Excel文件！"] = "Only support Excel file!";
catalog["请选择要测试的门！"] = "Please choose the testing door!";
