...
# Python 3: built-in set is available
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--fixtures', action='store_true', dest='infixtures', default=False,
                            help='Only look in app.fixtures subdir')
        parser.add_argument('--noscripts', action='store_true', dest='noscripts', default=False,
        ...
        parser.add_argument('--no-traceback', action='store_true', dest='no_traceback', default=False,
    ...
    def handle(self, *scripts, **options):
        ...
        def run_script(mod):
            ...
            try:
                ...
                # If silent, don't print errors or tracebacks
                if silent:
                    return
                # Otherwise print a helpful error message (if verbosity enabled)
                if verbosity > 0:
...
# Django provides the standard --verbosity/-v option; no optparse compatibility needed.
