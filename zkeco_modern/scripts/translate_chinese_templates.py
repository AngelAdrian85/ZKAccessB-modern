...
This script performs a conservative pass replacing Chinese strings
inside `{% trans %}` blocks with English equivalents (or placeholders).
Backups are saved as `.bak` before files are modified.
"""
